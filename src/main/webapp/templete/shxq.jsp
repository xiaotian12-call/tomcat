...
<head>
    ...
    <script>
        ...
        function qx() {
            window.location="xvqiu?method=xsallxq";
        }
        function fsxz() {
            $("#allbm").empty();
            var data0=["办公室","人事处","机关党委","政策法规处","计划财务处","平台与基础处","国际合作处","高新技术处","农村科技处"];
            var data1=["社会发展处","成果与市场处","监察室","离退休干部处","知识产权局","半干旱中心","山办","机关服务中心"];
            var data2=["科技研发中心","科技情报研究院","器材公司","基金办","档案馆","科技管理信息中心","科技投资中心","成果转换中心","中小企业创新资金管理中心","对外交流中心"];
            var xz = $("select[id = 'xz']").val();
            //alert(xz);
            if(xz=='0'){
                for(var i=0;i<data0.length;i++){
                    var value = data0[i];
                    $("#allbm").append("<option value="+value+">"+value+"</option>")
                }
            }else if(xz=='1'){
...
<form action="sh?method=shenhe" method="post" >
    ...
    <div style="align-content: center;margin-top: 20px;width: 90%;margin-left: 4%">
        <table class="table" border="1">
            ...
            <tr id="bmcz">
                <td><h3 align="center">管理处室选择</h3></td>
                <td colspan="3" align="center">
			        <select onchange="fsxz()" class="form-control" style="width: 200px;height: 30px;display: inline;align-self: center;" id="xz">
                        <option value="99">筛选条件</option>
                        <option value="0">0</option>
                        <option value="1">1</option>
                        <option value="2">2</option>
                    </select>
                    <select class="form-control" name="bmsh"style="width: 200px;height: 30px;display: inline;margin-right: 50%" id="allbm">
            ...
            <tr>
                <td > <input type="button" value="同意" class="btn btn-default" onclick="tyxq()"></td>
                <td > <input type="button" value="不同意" class="btn btn-default" onclick="bty()"></td>
                <td > <input type="submit" value="提交" class="btn btn-default" ></td>
                <td > <input type="button" value="取消" class="btn btn-default" onclick="qx()"></td>
            </tr>
