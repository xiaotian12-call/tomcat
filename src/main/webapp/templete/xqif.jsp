...
<form action="templete/xvqiu?method=createXvQiu" method="post">
	<table >
		<tr>
		...
		<tr>
			...
			<textarea style="height: 200px;width: 600px" name="context" id="content"  readonly="readonly"
		...
		<tr>
			<td ><h3 align="center">计划总投资 &nbsp;&nbsp;<input type="number"  min="0.00" max="500.00" step="0.01" readonly="readonly" name="money" style="width: 200px" value="${param.money }">万元</h3></td>
